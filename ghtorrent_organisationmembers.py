...
delete = "Drop table if exists ghtorrent_orgmembers"
print (delete)

mydata = cursor.execute(delete)

cursor.execute("""CREATE TABLE ghtorrent_orgmembers(org_id integer NOT NULL, user_id integer NOT NULL, created_at timestamp without time zone NOT NULL)""")
...
#for row in csv_data:
    #for column in row:
        #count = count + 1;
    #if count == 13:
cursor.execute("COPY ghtorrent_orgmembers FROM '/data/aditi/raw_data/github/organization_members.csv' DELIMITER ',' CSV NULL AS '\N'")
